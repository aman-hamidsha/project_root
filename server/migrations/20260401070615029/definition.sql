...
--
-- Class ScenarioResponse as table scenario_response
--
...
-- Indexes
CREATE INDEX "scenario_response_user_created_idx" ON "scenario_response" USING btree ("userId", "createdAt");
CREATE INDEX "scenario_response_simulator_idx" ON "scenario_response" USING btree ("simulator");

--
-- Class UserProgress as table user_progress
--
CREATE TABLE "user_progress" (
    "id" bigserial PRIMARY KEY,
    "userId" text NOT NULL,
    "totalPlayed" bigint NOT NULL,
    "totalScore" bigint NOT NULL,
    "averageScore" double precision NOT NULL,
    "currentStreakDays" bigint NOT NULL,
    "bestStreakDays" bigint NOT NULL,
    "lastPlayedAt" timestamp without time zone
);

-- Indexes
CREATE UNIQUE INDEX "user_progress_user_idx" ON "user_progress" USING btree ("userId");
...
--
-- MIGRATION VERSION FOR cs310
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('cs310', '20260401070615029', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260401070615029', "timestamp" = now();
